						...
						<div class="card">
		    				<div class="card-image">
		    					...
		    					<a href="{{ url('/buku/detail',$buku->judul_slug) }}">
		    						<img src="{{ $buku->foto_buku != NULL ? asset('/admin-assets/foto_buku/'.$buku->foto_buku) : asset('/admin-assets/foto_buku/book.png') }}" draggable="false">
		    					</a>
		    					</figure>
		    				</div>
		    				<div class="card-content">
								...
								<div>
				 				...
				 				<div>
					 				<a href="{{ url('/buku/kategori',$buku->slug_kategori) }}" class="tag is-danger">{{ $buku->nama_kategori }}</a>
					 				<a href="{{ url('/buku/kategori/sub',$buku->slug_sub_ktg) }}" class="tag is-success">{{ $buku->nama_sub }}</a>
				 				</div>
			 				</div>
			 				<div class="content">
			 					<div class="columns is-gapless is-multiline is-mobile">@if (Auth::check())
			 							@if(count($cek) > 0)
			 				...
			 				<div class="content">
			 					<div class="columns is-gapless is-multiline is-mobile">
			 						@if (Auth::check())
			 							@if(count($cek) > 0)
				 							<div class="column is-10-desktop is-half-mobile">
				 								<button class="button is-borrow pinjam"><s>Pinjam</s></button>
				 							</div>
				 						@else
				 							<div class="column is-10-desktop is-half-mobile">
				 								<button class="button is-primary pinjam">Pinjam</button>
