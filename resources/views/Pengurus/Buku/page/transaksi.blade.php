		...
		<div class="box box-danger">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<p class="form-control">{{ $transaksi->kelas }}</p>
				</div>
				<div class="form-group">
		...
		<div class="box box-danger">
			...
			<div class="box-body">
				<div class="form-group">
					...
					<input type="number" name="nmr_induk" class="form-control" placeholder="Nomor Induk">
				</div>
				<div class="form-group">
					<label for="">Tanggal Pinjam</label>
					<input type="text" name="tanggal_pinjam" class="form-control" placeholder="Tanggal Pinjam" value="" disabled>
				</div>
				<div class="form-group">
					<label for="">Tanggal Harus Kembalikan</label>
					<input type="text" name="tanggal_jth_tmpo" class="form-control" placeholder="Tanggal Harus Kembalikan" value="" disabled>
				</div>
				<div class="form-group">
					<label for="">Atur Peminjaman</label>
					<select class="form-control">
						<option value="" selected disabled>Atur Peminjaman</option>
						<option value="1">Izinkan Pinjam</option>
						<option value="0">Batalkan Pinjam</option>
					</select>
				</div>			
